...
exports.uploadInfo = function (req, ssn, data, callback){
...
function makeFile(ssn, type, filesize){
...
exports.uploadPart = function(req, ssn, type, params, data){
	var track = ssn[type];
	...
	if (params.makefile || !track.fd)
		if (!makeFile(ssn, type, params.filesize))
...
exports.getMediaInfo = function(ssn, type, callback){
	...
	exec('strace -e_llseek,read avconv -ss 0.1 -i '+track.file+' -t 0 2>&1', {timeout: 2000}, function(err,stdout,stderr){
		/*
		 console.log("err", err);
